	...
	<ul class="nav navbar-top-links fundoNavBar-vertical" style="margin-left:260px">
		...
		<div class="exibeBudget">
			<div class="valorBudget <?=($ReceitaMes-$sobreGastoMesAnterior-$budgetMes)>=0 ? "positivo" : "negativo"?>">
				<span class="valor"><?php echo number_format($ReceitaMes-$sobreGastoMesAnterior-$budgetMes, 2, '.', ''); ?></span>
			...
			<div class="informacoesBudget">
				<table>
					<tbody>
						...
						<tr class="receitas"><td class="valor"><?=number_format($ReceitaMes, 2, '.', '')?></td><td class="descricao">Receitas (mês atual)</td></tr>
