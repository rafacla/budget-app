...
include('Entities/AbstractEntity.php');
include('Entities/AccountInfo.php');
include('Entities/BankAccount.php');
include('Entities/Institute.php');
include('Entities/SignOn.php');
include('Entities/Statement.php');
